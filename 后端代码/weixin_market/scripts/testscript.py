...
def login_add_coupon(openid):
    ...
    # user.coupon_set().creat(price='login',state=1,start_time=timezone.now())
    # user.coupon_set().creat(price='share_once',state=1,start_time=timezone.now())
    # user.coupon_set().creat(price='share_twice',state=1,start_time=timezone.now())
